            ...
            <Table size="small" sx={{ tableLayout: 'fixed' }}>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell align="center" sx={{ bgcolor: '#e3f2fd', fontWeight: 'bold', borderRight: 1, borderColor: 'divider', width: 'calc((100% - 420px) / 6)' }}>実装</TableCell>
                        ...
                        <TableBody>
                            <TableRow sx={{ height: 45 }}>
                                ...
                                <TableCell align="center" sx={{ bgcolor: '#fafafa', fontWeight: 'bold', color: '#212121', verticalAlign: 'middle' }}>
