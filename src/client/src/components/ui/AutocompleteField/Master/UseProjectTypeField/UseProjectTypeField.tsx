...
import { useGetProjectType } from '@front/hooks/consts';
...
function UseProjectTypeField(props: Props) {
    const { control, trigger } = useFormContext();
    const { t } = useTranslation();
    const getProjectType = useGetProjectType(t);
    const items = getProjectType();
